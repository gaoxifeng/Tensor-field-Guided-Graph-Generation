...
void main() {
 ...
 //   return;	
    ...
    gl_Position = mvp * (p - vertices[0].scale_value[0] * 0.2 *x);
    EmitVertex();
    gl_Position = mvp * (p + vertices[0].scale_value[0]* 0.2 *x);
    EmitVertex();
    EndPrimitive();
    ...
    gl_Position = mvp * (p - vertices[0].scale_value[1]* 0.2 *y);
    EmitVertex();
    gl_Position = mvp * (p + vertices[0].scale_value[1]* 0.2 *y);
    EmitVertex();
    EndPrimitive();
    ...
    gl_Position = mvp * (p - vertices[0].scale_value[2]* 0.2 *z);
    EmitVertex();
    gl_Position = mvp * (p + vertices[0].scale_value[2]* 0.2 *z);
    EmitVertex();
    EndPrimitive();
...
//   gl_Position = mvp * (p - vertices[0].scale_value[2]*0.1 *z);
//   EmitVertex();
//   gl_Position = mvp * (p + vertices[0].scale_value[2]*0.1 *z);
//   EmitVertex();
//   EndPrimitive();
